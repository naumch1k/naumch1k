...
<img align="left" alt="TypeScript" width="26px" src="https://raw.githubusercontent.com/github/explore/80688e429a7d4ef2fca1e82350fe8e3517d3494d/topics/typescript/typescript.png" title="TypeScript"/>
...
🤘    [ONE FALL](https://develop--one-fall.netlify.app/)  — designed, prototyped, and developed a website for a Salem-based melodic punk/hardcore quartet, implementing custom UI and media features, CI/CD pipelines with GitHub Actions, and a streamlined workflow using a [GitHub Projects](https://github.com/users/naumch1k/projects/2/views/2) for automated task and issue tracking. **Do yourself a favor and check out the Gallery and give Rats Abandon Ship a listen!**

🍔    [Stellar Burgers](https://naumch1k.github.io/stellar-burgers/) is my ongoing portfolio project, serving as a playground for advanced React techniques and a journey to deepen my expertise in TypeScript and Redux
...
<!--[Around the U.S.](https://gramnaumchik.xyz/sign-in) - an online photo-sharing app built during the Practicum Bootcamp, implemented in multiple versions including Vanilla JavaScript, OOP-based JavaScript, and React
...
### Education
- [HarvardX][harvardx] CS50’s Introduction to Databases with SQL | 2025 - current
